...
export const AVATAR_PARTS = [
  { key: "head", file: "avatar_head.llm.gz", baked: BAKED_HEAD },
  { key: "upper", file: "avatar_upper_body.llm.gz", baked: BAKED_UPPER },
  { key: "lower", file: "avatar_lower_body.llm.gz", baked: BAKED_LOWER },
  // The eyelashes are part of the head bake and are modelled in place.
  { key: "eyelashes", file: "avatar_eyelashes.llm.gz", baked: BAKED_HEAD, fallback: 0x2b2119 },
  ...
  { key: "eyeL", file: "avatar_eye.llm.gz", baked: BAKED_EYES, joint: "mEyeLeft", fallback: 0xbdb6ae },
  { key: "eyeR", file: "avatar_eye.llm.gz", baked: BAKED_EYES, joint: "mEyeRight", fallback: 0xbdb6ae },
];
